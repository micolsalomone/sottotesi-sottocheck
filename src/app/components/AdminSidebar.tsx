...
const extraSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: 'TesiCheck Coach', path: '/sottocheck/job' },
  ...
  },
  {
    ...
    items: [
      { label: 'Check TesiCheck', path: '/sottocheck/check' },
      { label: 'Lavorazioni TesiCheck', path: '/sottocheck/lavorazioni' },
      { label: 'Impostazioni TesiCheck', path: '/sottocheck/impostazioni' },
