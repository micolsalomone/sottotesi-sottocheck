...
export interface CoachPayout {
  id: string;
  document_type?: 'notula' | 'fattura';
  notula_number?: string;
  notula_status?: 'da_programmare' | 'creata' | 'programmata' | 'inviata' | 'da_pagare' | 'pagata';
  sent_manually?: boolean;
  invoice_status?: 'da_ricevere' | 'ricevuta' | 'pagata';
  notula_issue_date?: string;
  notula_sent_date?: string;
  invoice_date?: string;
...
const INITIAL_PIPELINES: Pipeline[] = [
  ...
  { 
    ...
    service_link: 'coaching',
    quotes: [
      { id: 'Q-002', number: '156/2025', status: 'paid', sent_at: '2025-11-01', expires_at: '2025-12-01' }
    ]
  },
  { 
    ...
    quotes: [
      { id: 'Q-003', number: '098/2024', status: 'paid', sent_at: '2024-09-10', expires_at: '2024-10-10' }
    ]
  },
  { 
    ...
    service_link: 'coaching',
    quotes: [
      { id: 'Q-004', number: '001/2026', status: 'paid', sent_at: '2026-01-10', expires_at: '2026-02-10' }
    ]
  },
  { 
    ...
    quotes: [
      { id: 'Q-005', number: '088/2025', status: 'paid', sent_at: '2025-08-05', expires_at: '2025-09-05' }
    ]
  },
  { 
    ...
    service_link: 'coaching_plus',
    quotes: [
      { id: 'Q-006-1', number: '178/2024', status: 'paid', sent_at: '2024-11-01', expires_at: '2024-12-01' },
      { id: 'Q-006-2', number: '045/2025', status: 'paid', sent_at: '2025-10-05', expires_at: '2025-11-05' }
    ]
  },
  { 
  ...
  { 
    ...
    service_link: 'coaching',
    quotes: [
      { id: 'Q-008', number: '012/2025', status: 'paid', sent_at: '2025-12-05', expires_at: '2026-01-05' }
    ]
  },
  { 
    ...
    service_link: 'coaching_plus',
    quotes: [
      { id: 'Q-009', number: '075/2025', status: 'paid', sent_at: '2025-07-10', expires_at: '2025-08-10' }
    ]
  },
  { 
    ...
    service_link: 'coaching_plus',
    quotes: [
      { id: 'Q-010', number: '062/2025', status: 'paid', sent_at: '2025-06-15', expires_at: '2025-07-15' }
    ]
  },
  { 
    ...
    service_link: 'starter_pack',
    quotes: [
      { id: 'Q-021', number: '154/2025', status: 'paid', sent_at: '2025-12-01', expires_at: '2026-01-01' }
    ]
  },
  { 
  ...
  { 
    ...
    service_link: 'coaching',
    quotes: [
      { id: 'Q-023', number: '008/2026', status: 'paid', sent_at: '2026-01-15', expires_at: '2026-02-15' }
    ]
  },
  { 
    ...
    service_link: 'starter_pack',
    quotes: [
      { id: 'Q-024', number: '055/2025', status: 'paid', sent_at: '2025-05-25', expires_at: '2025-06-25' }
    ]
  },
  { 
    ...
    service_link: 'coaching',
    quotes: [
      { id: 'Q-025', number: '092/2025', status: 'paid', sent_at: '2025-09-10', expires_at: '2025-10-10' }
    ]
  },
  { 
    ...
    service_link: 'coaching_plus',
    quotes: [
      { id: 'Q-026', number: '002/2026', status: 'paid', sent_at: '2026-01-05', expires_at: '2026-02-05' }
    ]
  },
  ...
  { 
    ...
    service_link: 'coaching',
    quotes: [
      { id: 'Q-027', number: '110/2025', status: 'paid', sent_at: '2025-09-15', expires_at: '2025-10-15' }
    ],
  ...
  { 
    ...
    service_link: 'starter_pack',
    quotes: [
      { id: 'Q-028', number: '148/2025', status: 'paid', sent_at: '2025-11-15', expires_at: '2025-12-15' }
    ],
  ...
  { 
    ...
    service_link: 'coaching',
    quotes: [
      { id: 'Q-030', number: '025/2026', status: 'paid', sent_at: '2026-03-01', expires_at: '2026-03-25' }
    ],
    assigned_to: ['Team Bologna']
  },
  { 
  ...
  { 
    id: 'PIP-032', student_id: 'STU-615', student_name: 'Irene Bassi', first_name: 'Irene', last_name: 'Bassi', email: 'irene.bassi@gmail.com', sources: ['Gmail'], created_at: '2026-02-20', updated_at: '2026-02-26T14:00:00', updated_by: 'Francesca', lavorazioni_ids: ['SS-168'],
    service_link: 'coaching',
    quotes: [
      { id: 'Q-032', number: '020/2026', status: 'paid', sent_at: '2026-02-25', notes: 'Prezzo troppo alto per il budget dello studente' }
    ],
    assigned_to: ['Team Torino']
  },
  { 
    id: 'PIP-033', student_id: 'STU-622', student_name: 'Riccardo Tosi', first_name: 'Riccardo', last_name: 'Tosi', email: 'riccardo.tosi@student.unibo.it', phone: '+39 333 4441122', sources: ['IG'], created_at: '2026-01-15', updated_at: '2026-02-21T15:30:00', updated_by: 'Claudia', lavorazioni_ids: ['SS-169'],
    service_link: 'starter_pack',
    quotes: [
      { id: 'Q-033', number: '006/2026', status: 'paid', sent_at: '2026-01-20', expires_at: '2026-02-20' }
    ],
    assigned_to: ['Fornitore Esterno']
  },
  { 
    id: 'PIP-034', student_id: 'STU-629', student_name: 'Camilla Ferretti', first_name: 'Camilla', last_name: 'Ferretti', email: 'camilla.ferretti@email.com', sources: ['Sottotelefono BO'], created_at: '2026-03-14', updated_at: '2026-03-14T16:00:00', updated_by: 'Francesca', lavorazioni_ids: ['SS-170'],
    service_link: 'coaching_plus',
    quotes: [
      { id: 'Q-034', number: '030/2026', status: 'paid', sent_at: '2026-03-14', expires_at: '2026-03-18' }
    ],
