...
| `/public-view/profilo` | Public | PublicLayout | Profilo standalone (dati personali + arricchimento Pipeline). Nel sidebar è nello slot secondario in basso (allineato a Student/Admin). Cross-link a `/public-view/account` |
